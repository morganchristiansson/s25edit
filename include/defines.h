...
// s2Id values for standard terrain types (used in map file format)
constexpr uint8_t S2ID_STEPPE_MEADOW1 = 0x00;
constexpr uint8_t S2ID_MINING1 = 0x01;
constexpr uint8_t S2ID_SNOW = 0x02;
constexpr uint8_t S2ID_SWAMP = 0x03;
constexpr uint8_t S2ID_STEPPE = 0x04;
constexpr uint8_t S2ID_WATER = 0x05;
constexpr uint8_t S2ID_MEADOW1 = 0x08;
constexpr uint8_t S2ID_MEADOW2 = 0x09;
constexpr uint8_t S2ID_MEADOW3 = 0x0A;
constexpr uint8_t S2ID_MINING2 = 0x0B;
constexpr uint8_t S2ID_MINING3 = 0x0C;
constexpr uint8_t S2ID_MINING4 = 0x0D;
constexpr uint8_t S2ID_STEPPE_MEADOW2 = 0x0E;
constexpr uint8_t S2ID_FLOWER = 0x0F;
constexpr uint8_t S2ID_LAVA = 0x10;
constexpr uint8_t S2ID_MINING_MEADOW = 0x12;
/// Editor-internal sentinel: pick random meadow texture when painting
constexpr uint8_t S2ID_MEADOW_MIXED = 0xBF;
/// Editor-internal sentinel: pick random meadow texture with harbour
constexpr uint8_t S2ID_MEADOW_MIXED_HARBOUR = 0xFF;
/// Harbour bit mask
constexpr uint8_t HARBOUR_BIT = 0x40;

// Backward-compatible aliases for legacy code (to be migrated)
// @{
#define TRIANGLE_TEXTURE_STEPPE_MEADOW1 S2ID_STEPPE_MEADOW1
#define TRIANGLE_TEXTURE_MINING1 S2ID_MINING1
#define TRIANGLE_TEXTURE_SNOW S2ID_SNOW
#define TRIANGLE_TEXTURE_SWAMP S2ID_SWAMP
#define TRIANGLE_TEXTURE_STEPPE S2ID_STEPPE
#define TRIANGLE_TEXTURE_WATER S2ID_WATER
#define TRIANGLE_TEXTURE_MEADOW1 S2ID_MEADOW1
#define TRIANGLE_TEXTURE_MEADOW2 S2ID_MEADOW2
#define TRIANGLE_TEXTURE_MEADOW3 S2ID_MEADOW3
#define TRIANGLE_TEXTURE_MINING2 S2ID_MINING2
#define TRIANGLE_TEXTURE_MINING3 S2ID_MINING3
#define TRIANGLE_TEXTURE_MINING4 S2ID_MINING4
#define TRIANGLE_TEXTURE_STEPPE_MEADOW2 S2ID_STEPPE_MEADOW2
#define TRIANGLE_TEXTURE_FLOWER S2ID_FLOWER
#define TRIANGLE_TEXTURE_LAVA S2ID_LAVA
#define TRIANGLE_TEXTURE_MINING_MEADOW S2ID_MINING_MEADOW
#define TRIANGLE_TEXTURE_MEADOW_MIXED S2ID_MEADOW_MIXED
#define TRIANGLE_TEXTURE_MEADOW_MIXED_HARBOUR S2ID_MEADOW_MIXED_HARBOUR
// Harbour variants
#define TRIANGLE_TEXTURE_STEPPE_MEADOW1_HARBOUR (S2ID_STEPPE_MEADOW1 | HARBOUR_BIT)
#define TRIANGLE_TEXTURE_MEADOW1_HARBOUR (S2ID_MEADOW1 | HARBOUR_BIT)
#define TRIANGLE_TEXTURE_MEADOW2_HARBOUR (S2ID_MEADOW2 | HARBOUR_BIT)
#define TRIANGLE_TEXTURE_MEADOW3_HARBOUR (S2ID_MEADOW3 | HARBOUR_BIT)
#define TRIANGLE_TEXTURE_STEPPE_MEADOW2_HARBOUR (S2ID_STEPPE_MEADOW2 | HARBOUR_BIT)
#define TRIANGLE_TEXTURE_FLOWER_HARBOUR (S2ID_FLOWER | HARBOUR_BIT)
#define TRIANGLE_TEXTURE_MINING_MEADOW_HARBOUR (S2ID_MINING_MEADOW | HARBOUR_BIT)
// @}
