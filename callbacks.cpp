    ...
    switch(Param)
    {
        case INITIALIZING_CALL:
            ...
            SelectBoxHelp = WNDHelp->addSelectBox(Position(0, 0), Extent(WNDHelp->getSize() - WNDHelp->getBorderSize()),
                                                  FontSize::Normal, FontColor::Yellow, BUTTON_GREEN1);
...
void callback::EditorLoadMenu(int Param)
{
    ...
    switch(Param)
    {
        case INITIALIZING_CALL:
        {
            ...
            CB_Filename = WNDLoad->addSelectBox(Position(10, 5), Extent(160, 280), FontSize::Normal);
            curFilename.clear();
...
// this is a submenu for testing (removed)
